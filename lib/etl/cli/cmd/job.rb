...
module ETL::Cli::Cmd
  class Job < ETL::Cli::Command
    ...
    class Run < ETL::Cli::Command
      ...
      option ['-b', '--batch'], "BATCH", "Batch for the job in JSON or 'key1=value1;key2=value2' format" do |str|
        @batch = ETL::Batch.parse(str)
      end
